                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        @foreach($biens as $bien)
                            <tr>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">{{$bien->description}}</td>
                                <td class="px-6 py-4 whitespace-nowrap">{{$bien->statu}}</td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <span
                                        class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{{$bien->adresse}}</span>
                                </td>
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <a href=""
